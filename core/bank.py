...
class Bank:
    ...
    def transfer_money(
        ...
        sender.add_notification(

            "Transfer",

            f"You sent {amount:.2f} to account {receiver.account_number}."

        )



        receiver.add_notification(

            "Transfer",

            f"You received {amount:.2f} from account {sender.account_number}."
